...
import {activeUser, openUserSidebar, setFullUser} from "../../../redux/actions";
                        ...
                        <div className="d-flex align-items-center">
                            ...
                            <div className="flex-grow-1 overflow-hidden">
                                <h5 className="font-size-16 mb-0 text-truncate">
                                    <Link to="#" onClick={(e) => e.preventDefault()} className="text-reset user-profile-show">
                                        {JSON.parse(localStorage.getItem('activeApp')).applicationTitle}
                                    </Link>
                                    {/*{(() => {
                                ...
                                <Dropdown isOpen={dropdownOpen} toggle={toggle}>
                                    ...
                                    <DropdownMenu className="p-0 dropdown-menu-end dropdown-menu-md">
                                        <div className="search-box p-2">
                                            <Input type="text" className="form-control bg-light border-0" placeholder="جستجو..."/>
                                        </div>
                                    </DropdownMenu>
                                </Dropdown>
                            </li>
...
export default connect(mapStateToProps, { openUserSidebar, setFullUser , activeUser })(UserHead);